    ...
    for (const [key, value] of Object.entries(obj)) {
      ...
      if (newValue.meta) {
        if(newValue.meta.sliceNameOverride){
          newValue.meta.sliceNameOverride = "Loc2.1: " + t(newValue.meta.sliceNameOverride);
        }
        if(newValue.meta.code){
          newValue.meta.code = t(newValue.meta.code) +  " :Loc2.2";
        }
        if(newValue.meta.text){
          newValue.meta.text = "Loc2.3: " + t(newValue.meta.text);
        }
      }
