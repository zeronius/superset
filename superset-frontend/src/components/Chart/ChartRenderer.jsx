...
class ChartRenderer extends Component {
  constructor(props) {
    ...
    // TODO PCM here we remap the whole queries response data so it show localized texts in labels, legends, etc
    this.mutableQueriesResponse = remapAllAttrs(cloneDeep(this.props.queriesResponse), t);
  }
